...
class FinetuningArguments(
    ...
    asft_alpha: float = field(
        default=0.1,
        metadata={
            "help": "The alpha parameter for ASFT loss to control the power of adaptive weight."
        },
    )
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "oft", "freeze", "full"], (
            "Invalid fine-tuning method."
        )
        assert self.ref_model_quantization_bit in [None, 8, 4], (
            "We only accept 4-bit or 8-bit quantization."
        )
        assert self.reward_model_quantization_bit in [None, 8, 4], (
            "We only accept 4-bit or 8-bit quantization."
        )
